...
if ( is_search() ) {
	...
	echo '<div class="border-box  xs-w100">';
		if ( wp_is_mobile() ) {
			echo '<a href="https://youtu.be/XNINUffRfTc" target="_blank">Ver video</a>';
		} else {
			echo '<iframe width="640" height="360" src="https://www.youtube-nocookie.com/embed/XNINUffRfTc" frameborder="0" allowfullscreen></iframe>';
		}
	echo '</div>';
}
